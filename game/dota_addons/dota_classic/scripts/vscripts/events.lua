...
function GameMode:OnGameRulesStateChange(keys)
        ...
        if new_state == DOTA_GAMERULES_STATE_GAME_IN_PROGRESS then
                ...
                Entities:FindByName(nil, "radiant_tower_top_1"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_top_1"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_top_2"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_top_2"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_top_3"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_top_3"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_top_4"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_top_4"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_mid_1"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_mid_1"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_mid_2"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_mid_2"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_mid_3"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_mid_3"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_mid_4"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_mid_4"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_bot_1"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_bot_1"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_bot_2"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_bot_2"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_bot_3"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_bot_3"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_bot_4"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_bot_4"), nil, "modifier_health_regen_nighttime", nil)
                Entities:FindByName(nil, "radiant_tower_base_1"):AddNewModifier(Entities:FindByName(nil, "radiant_tower_base_1"), nil, "modifier_health_regen_nighttime", nil)
