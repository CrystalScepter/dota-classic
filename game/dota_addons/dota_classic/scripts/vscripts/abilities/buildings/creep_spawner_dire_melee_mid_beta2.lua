...
creep_spawner_dire_melee_mid_beta2 = class({})

-- Link the modifiers that are going to be used by our ability
LinkLuaModifier("modifier_creep_spawner_dire_melee_mid_beta2", "abilities/buildings/creep_spawner_dire_melee_mid_beta2.lua", LUA_MODIFIER_MOTION_NONE)

-- Return the name of the modifier
function creep_spawner_dire_melee_mid_beta2:GetIntrinsicModifierName()
	return "modifier_creep_spawner_dire_melee_mid_beta2"
end
...
modifier_creep_spawner_dire_melee_mid_beta2 = class({})

-- Called when the modifier is created
function modifier_creep_spawner_dire_melee_mid_beta2:OnCreated(keys)
...
function modifier_creep_spawner_dire_melee_mid_beta2:OnIntervalThink()
	-- Retrieve the values that are going to be used when the modifier thinks
	local spawner_name = "lane_melee_mid_spawner_badguys"
...
function modifier_creep_spawner_dire_melee_mid_beta2:IsHidden()
	return true
end

-- Make the modifier undispellable
function modifier_creep_spawner_dire_melee_mid_beta2:IsPurgable()
        return false
end
