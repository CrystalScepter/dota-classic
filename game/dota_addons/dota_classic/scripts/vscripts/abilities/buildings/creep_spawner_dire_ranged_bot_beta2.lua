...
creep_spawner_dire_ranged_bot_beta2 = class({})

-- Link the modifiers that are going to be used by our ability
LinkLuaModifier("modifier_creep_spawner_dire_ranged_bot_beta2", "abilities/buildings/creep_spawner_dire_ranged_bot_beta2.lua", LUA_MODIFIER_MOTION_NONE)

-- Return the name of the modifier
function creep_spawner_dire_ranged_bot_beta2:GetIntrinsicModifierName()
	return "modifier_creep_spawner_dire_ranged_bot_beta2"
end
...
modifier_creep_spawner_dire_ranged_bot_beta2 = class({})

-- Called when the modifier is created
function modifier_creep_spawner_dire_ranged_bot_beta2:OnCreated(keys)
...
function modifier_creep_spawner_dire_ranged_bot_beta2:OnIntervalThink()
	-- Retrieve the values that are going to be used when the modifier thinks
	local spawner_name = "lane_ranged_bot_spawner_badguys"
	local destination_name = "lane_bot_pathcorner_goodguys_1"
	local destination_name_2 = "lane_mid_pathcorner_badguys_1"
	local unit_to_spawn = "npc_dire_ranged_creep_beta2"
...
function modifier_creep_spawner_dire_ranged_bot_beta2:IsHidden()
	return true
end

-- Make the modifier undispellable
function modifier_creep_spawner_dire_ranged_bot_beta2:IsPurgable()
        return false
end
